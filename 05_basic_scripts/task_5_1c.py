...
name_of_device = input("Введите имя устройства: ")
print(london_co[name_of_device].get(input("Введите имя параметра: " + "(" +str(london_co[name_of_device].keys()).replace("'", "")[11:-2] + ") ")),"Такого параметра нет")